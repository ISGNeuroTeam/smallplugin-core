...
case class RandomForestClassifier(featureCols: List[String], targetCol: String, dataFrame: DataFrame, modelName: String, keywords: Map[String,String], searchId:Int, utils: PluginUtils) {
  import utils._
  def createPipeline() = {
